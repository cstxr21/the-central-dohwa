...
const STEPS = [
  ...
  { no: "03", t: "견본주택 방문·상담", d: "현장에서 평면·마감과 동·호 지정·잔여 세대를 상담합니다." },
];

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "RealEstateAgent",
  name: `${content.project.name} 견본주택`,
    ...
    <>
      ...
      <section className="bg-surface">
        <div className="mx-auto grid max-w-[1280px] items-start gap-12 px-6 py-16 sm:px-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-2 text-[16px] text-muted">견본주택 · {MODELHOUSE.address}</p>
            <p className="mt-6 text-[17px] leading-[1.9] text-muted">
              실물 견본주택에서 단위세대 평면과 마감재, 커뮤니티·특화 설계를 직접 경험하실 수 있습니다. 방문 전 온라인으로 예약해 주시면
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-[920px] px-6 py-16 sm:px-10 sm:py-20">
          ...
          <dl className="mt-8 border-t border-line">
            {[
              { label: "견본주택 주소", value: MODELHOUSE.address },
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-[1024px] px-6 py-16 sm:px-10">
          <SectionHeading no="02" en="Gallery" title="견본주택 안내" />
          <div className="mt-10">
            <Figure src="/images/hero/doosan-the-central-dohwa-modelhouse-01.png" w={1529} h={955} alt="두산위브 더센트럴 도화 모델하우스" caption="견본주택 안내 (연출된 가구·유상옵션이 포함될 수 있습니다)" />
          </div>
          <p className="mt-6 text-[15px] text-muted">
            ...
            에서 확인하실 수 있습니다. 견본주택 연출 컷은 실제와 차이가 있을 수 있습니다.
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-[920px] px-6 py-16 sm:px-10 sm:py-20">
          ...
          <div className="mt-8 space-y-6 text-[17px] leading-[1.9] text-muted">
            <p>
              두산위브 더센트럴 도화 모델하우스(견본주택)는 인천광역시 미추홀구 숭의동 117-11번지에 운영합니다. 실물 견본주택에서 단위세대
              평면과 마감재, 커뮤니티·특화 설계를 직접 확인하실 수 있으며, 관람은 10:00부터 18:00까지 사전 예약제로 진행됩니다.
            </p>
            <p>
              방문은 온라인 방문예약 신청 → 담당자 확인·일정 조율 연락 → 견본주택 방문·상담의 3단계로 진행됩니다. 방문·분양 문의는{" "}
